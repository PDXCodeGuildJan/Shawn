...
'Citrullus colocynthis':'Colocynth or Bitter Apple',
'Claviceps purpurea':'Ergot Fungus',
'Colchicum autumnale':'Meadow Saffron or Naked Lady',
'Conium maculatum':'Poison Hemlock, an Apiaceae',
'Crocus sativa':'Saffron',
'Croton tiglium':'bā dòu or Jamaal Gota',
'Cytisus scoparius':'Scotch Broom',
'Drypoteris filixmas':'Worm Fern',
'Ephedra vulgaris':'Ma Huang or Teamsters Tea',
...
def hangperson():
   ...
   listedWord = list(a_string.lower())
   currentState = ""
